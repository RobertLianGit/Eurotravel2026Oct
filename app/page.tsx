...
const dailyMaps: Record<string, DayMap> = {
  ...
  "day-02": {
    city: "罗马",
    subtitle: "08:30 温暖酒店集合 → 打车到许愿池 → 历史中心步行线",
    center: [41.895, 12.478],
    bbox: [12.43, 41.80, 12.52, 41.92],
    hotel: hotelAnchors.rome,
    points: [
      { name: "许愿池 / 特莱维喷泉", query: "Trevi Fountain, Rome", kind: "visit", travelMode: "taxi", coordinates: [41.9009, 12.4833], note: "最终确定的第一站：从温暖酒店打车抵达" },
      { name: "西班牙广场", query: "Spanish Steps, Rome", kind: "visit", coordinates: [41.9059, 12.4828], note: "从许愿池向北步行，减少后续折返" },
      { name: "圣伊纳爵教堂", query: "Church of Saint Ignatius of Loyola, Rome", kind: "visit", coordinates: [41.8994, 12.4791], note: "重点看安德烈亚·波佐的透视穹顶画" },
      { name: "万神殿", query: "Pantheon, Rome", kind: "visit", coordinates: [41.8986, 12.4769], note: "从巴洛克视觉幻象转到古罗马宇宙秩序" },
      { name: "威尼斯广场", query: "Piazza Venezia, Rome", kind: "visit", coordinates: [41.8958, 12.4823] },
      { name: "帝国大道", query: "Via dei Fori Imperiali, Rome", kind: "visit", coordinates: [41.8927, 12.4885], note: "沿古罗马广场向斗兽场前进" },
      { name: "斗兽场", query: "Colosseum, Rome", kind: "visit", coordinates: [41.8902, 12.4922], note: "看皇帝如何组织城市大众；入内时间以票面为准" },
      { name: "真理之口", query: "Bocca della Verità, Rome", kind: "visit", coordinates: [41.8884, 12.4817], note: "当日最后一站；体力不足时可从斗兽场打车" },
    ],
    relationship: "先从酒店打车到许愿池，再按西班牙广场—圣伊纳爵教堂—万神殿—威尼斯广场—帝国大道—斗兽场一路向南；最后到真理之口，能明显减少原名单的来回折返。",
    note: "9 月 27 日 08:30 在温暖酒店集合，第一段已确定打车去许愿池；斗兽场若有固定入场票，以票面时间反向调整中间各站停留。",
  },
  "day-03": {
    city: "罗马｜梵蒂冈",
    subtitle: "上午梵蒂冈博物馆 → 圣天使堡外观 → 纳沃纳广场",
    center: [41.901, 12.463],
    bbox: [12.43, 41.80, 12.485, 41.925],
    hotel: hotelAnchors.rome,
    contextPoints: [
      { name: "圣彼得大殿", query: "St. Peter's Basilica, Vatican City", kind: "context", coordinates: [41.9022, 12.4539], note: "四座教宗大殿之一；此次是否进入尚未确认" },
    ],
    points: [
      { name: "梵蒂冈博物馆", query: "Vatican Museums", kind: "visit", coordinates: [41.9065, 12.4536], note: "上午预约参观；具体入场时间以票面为准", displayOffset: [3, -3] },
      { name: "西斯廷教堂", query: "Sistine Chapel, Vatican City", kind: "visit", coordinates: [41.9031, 12.4545], note: "包含在梵蒂冈博物馆参观动线内", displayOffset: [7, 0] },
      { name: "圣天使堡", query: "Castel Sant'Angelo, Rome", kind: "visit", coordinates: [41.9031, 12.4663], note: "按现有安排顺路经过，默认看外观" },
      { name: "纳沃纳广场", query: "Piazza Navona, Rome", kind: "visit", coordinates: [41.8992, 12.4731], note: "当天主线终点" },
    ],
    relationship: "梵蒂冈博物馆参观结束后向东步行到圣天使堡，再跨过台伯河前往纳沃纳广场；这是一条连续向罗马历史中心推进的路线。",
    note: "四座主要教宗大殿和耶路撒冷圣十字圣殿仍是待确认候选，不自动塞进这条已经很完整的半日主线。",
  },
  "day-04": {
    city: "佛罗伦萨",
  ...
  "day-11": {
    ...
    note: "网球厅已加入第11天正式补线；2026年10月6日是星期二，按目前公布安排12:30后可免费参观。巴黎圣母院已按最终确认移到10月7日。",
  },
  "day-12": {
    city: "巴黎",
    subtitle: "巴黎圣母院 → 奥赛美术馆 → 塞纳河畔晚餐",
    center: [48.856, 2.333],
    bbox: [2.28, 48.82, 2.38, 48.88],
    hotel: hotelAnchors.paris,
    points: [
      { name: "巴黎圣母院", query: "Notre-Dame de Paris", kind: "visit", coordinates: [48.853, 2.3499], note: "10 月 7 日已确定安排" },
      { name: "奥赛美术馆", query: "Musée d'Orsay, Paris", kind: "visit", coordinates: [48.86, 2.3266], note: "下午参观；入场时间以预约为准" },
      { name: "塞纳河畔", query: "Quai Anatole France, Paris", kind: "visit", coordinates: [48.861, 2.3254], note: "奥赛出来后看风景、吃饭" },
    ],
    relationship: "上午从巴黎圣母院开始，之后沿塞纳河向西前往奥赛美术馆；参观结束直接留在河畔看风景和吃饭，不再跨城加点。",
    note: "10 月 7 日已从自由日改为确定行程；餐厅仍可根据奥赛离馆时间和天气现场选择。",
  },
  "day-13": {
    city: "巴黎 → 北京",
...
const basePlans: DayPlan[] = [
  ...
  },
  {
    ...
    route: ["许愿池", "西班牙广场", "圣伊纳爵教堂", "万神殿", "威尼斯广场", "帝国大道", "斗兽场", "真理之口"], transport: ["08:30 温暖酒店集合 → 打车去许愿池", "历史中心按地理顺序步行；斗兽场 → 真理之口体力不足可打车"], meals: ["午餐：万神殿—威尼斯广场之间顺路解决；可选 Pane e Salame", "晚餐：斗兽场 / 真理之口结束后按体力决定，不为餐厅折返"],
    priorityReminder: { label: "最终集合安排 / 9 月 27 日", title: "08:30 温暖酒店集合，打车先去许愿池", body: "第一站已经确定。后续按西班牙广场—圣伊纳爵教堂—万神殿—威尼斯广场—帝国大道—斗兽场—真理之口向南推进，避免在罗马市中心来回折返。", items: ["Warmthotel｜Via Giuseppe Prezzolini 5｜08:30 集合", "第一段交通｜出租车｜温暖酒店 → 许愿池", "斗兽场若有固定入场时间｜以票面为准，反向调整前面停留"] },
    activities: [
      { id: "d2-1", time: "08:30", title: "集合 / 打车出发", place: "温暖酒店 Warmthotel", note: "两位在酒店集合，第一站直接去许愿池", kind: "move" },
      { id: "d2-2", time: "上午", title: "许愿池 → 西班牙广场", place: "Trevi Fountain → Piazza di Spagna", note: "先完成最容易拥挤的两个室外点", kind: "visit" },
      { id: "d2-3", time: "上午", title: "圣伊纳爵教堂 → 万神殿", place: "Sant’Ignazio → Pantheon", note: "看巴洛克视觉幻象，再进入古罗马穹顶", kind: "visit" },
      { id: "d2-4", time: "中午", title: "午餐 / 休息", place: "万神殿—威尼斯广场沿线", note: "给下午的古罗马步行线留体力", kind: "meal" },
      { id: "d2-5", time: "下午", title: "威尼斯广场 → 帝国大道 → 斗兽场", place: "Piazza Venezia → Via dei Fori Imperiali → Colosseo", note: "斗兽场入内时间以票面为准", kind: "visit" },
      { id: "d2-6", time: "傍晚", title: "真理之口", place: "Bocca della Verità", note: "当天最后一站；累了就从斗兽场打车", kind: "visit" },
    ],
    story: { title: "皇帝如何控制一座城市", question: "从许愿池一路走到斗兽场，为什么像在穿越不同层次的罗马？", lead: "今天不从遗址开场，而从仍在生活中的罗马出发：清晨的许愿池、西班牙广场和圣伊纳爵教堂，会先让你看到一座城市怎样不断覆盖、借用和重写自己的过去。", body: "从许愿池和西班牙广场出发，先看到的是今天仍在运转的罗马：游客、商业、街巷与巴洛克城市景观叠在一起。走进圣伊纳爵教堂时，抬头看那座其实并不存在的穹顶，画家用透视制造了一个比真实空间更宏大的天空。几分钟后走进万神殿，眼前却是真正由古罗马工程托起的巨大穹顶——同样是让人仰望，一个靠绘画幻觉，一个靠混凝土与结构。再经威尼斯广场走上帝国大道，古罗马广场和斗兽场逐渐出现，城市从巴洛克外衣里露出帝国骨架。斗兽场最值得讲的也不只是巨大，而是它把整个社会按身份安排在看台上，让皇帝通过娱乐、粮食与仪式管理人群。最后到真理之口，古代建筑碎片、宗教空间和现代传说又重新叠在一起。今天这条路真正说明的是：罗马从来不是一层历史，而是一座不断把旧权力改写成新日常的城市。", chapters: [{ label: "01", title: "许愿池到圣伊纳爵：城市制造幻象", text: "巴洛克罗马用水景、广场和透视画，让城市显得比真实空间更宏大。" }, { label: "02", title: "万神殿：工程制造宇宙", text: "真正的穹顶把政治权力包装成一种关于天地秩序的想象。" }, { label: "03", title: "帝国大道到斗兽场：权力组织人群", text: "道路、广场与看台共同把社会等级和皇帝的位置公开展示出来。" }, { label: "04", title: "真理之口：历史进入日常", text: "古代遗迹经过宗教和传说继续留在现代城市生活里。" }], prompt: "请按我9月27日的实际路线，写成可以边走边讲的5分钟口播：许愿池—西班牙广场—圣伊纳爵教堂—万神殿—威尼斯广场—帝国大道—斗兽场—真理之口。重点讲罗马怎样把巴洛克幻象、古代工程、帝国权力和现代日常叠在一起，并加入每站一个现场观察细节。\n\n现场补充：" },
    source: "正式方案 PDF + 9 月 27 日最终确认｜08:30 温暖酒店集合，打车先去许愿池",
  },
  {
    id: "day-03", number: "03", date: "9月28日", city: "罗马｜梵蒂冈", tag: "重点日", title: "帝国如何变成教皇世界",
    route: ["梵蒂冈博物馆", "西斯廷教堂", "圣天使堡（外观途经）", "纳沃纳广场"], transport: ["温暖酒店 → 梵蒂冈博物馆：按预约时间预留车程与安检", "梵蒂冈博物馆 → 圣天使堡 → 纳沃纳广场：步行串联"], meals: ["午餐：梵蒂冈博物馆结束后按预约节奏解决", "甜点休息：Old Bridge Gelateria（城墙外 Viale dei Bastioni di Michelangelo 5）", "晚餐：纳沃纳广场周边自选"],
    priorityReminder: { label: "待确认 / 不自动加入 9 月 28 日", title: "大殿名单里“圣保禄”重复了一次", body: "罗马四座主要教宗大殿的标准名单是圣彼得大殿、拉特朗圣若望大殿、圣母大殿和城外圣保禄大殿。原消息中的“圣保禄大殿”和“城外圣保禄大殿”应是同一处，可能漏写了圣彼得大殿；耶路撒冷圣十字圣殿可作为额外候选。", items: ["圣彼得大殿｜Basilica di San Pietro", "拉特朗圣若望大殿｜San Giovanni in Laterano", "圣母大殿｜Santa Maria Maggiore", "城外圣保禄大殿｜San Paolo fuori le Mura", "耶路撒冷圣十字圣殿｜Santa Croce in Gerusalemme｜额外候选"] },
    activities: [
      { id: "d3-1", time: "上午·按票面", title: "梵蒂冈博物馆", place: "Vatican Museums", note: "预约参观；预留安检与排队时间", kind: "visit" },
      { id: "d3-2", time: "馆内动线", title: "西斯廷教堂", place: "Sistine Chapel", note: "包含在博物馆参观动线内，把艺术讲成教皇权力的语言", kind: "visit" },
      { id: "d3-3", time: "中午", title: "午餐 / 休息", place: "梵蒂冈周边", note: "参观结束后再按实际离馆时间安排", kind: "meal" },
      { id: "d3-4", time: "下午", title: "顺路经过圣天使堡", place: "Castel Sant’Angelo", note: "默认看外观，不额外占用长时间入内参观", kind: "visit" },
      { id: "d3-5", time: "下午 / 傍晚", title: "纳沃纳广场", place: "Piazza Navona", note: "当天主线终点，晚餐可在周边安排", kind: "visit" },
    ],
    story: { title: "从教皇收藏到罗马街道：帝国为什么没有真正消失？", question: "一座博物馆、一座皇帝陵墓和一座巴洛克广场，为什么能连成同一条权力故事？", lead: "今天从梵蒂冈博物馆开始，不是为了完成一串名作清单，而是看教皇怎样把古代雕塑、基督教叙事和文艺复兴艺术重新编排成自己的世界史。", body: "进入梵蒂冈博物馆时，可以把它看成教皇对罗马遗产的收藏和重新解释。古代雕塑、宗教图像与文艺复兴艺术被放进同一条参观路径，让来到这里的人感觉：罗马不只拥有过去，它还拥有解释过去的资格。到了西斯廷教堂，故事再往前一步。米开朗基罗画的不是一张漂亮天花板，而是一套关于创世、救赎和人类位置的公共叙事；谁能委托、展示并解释这套叙事，谁就拥有塑造世界秩序的权力。\n\n离开梵蒂冈向圣天使堡走时，教皇世界又和古罗马直接接上：这座城堡最初是哈德良皇帝的陵墓，后来成为要塞和教皇避难空间。同一栋建筑从皇帝纪念碑变成教皇防御体系，正好说明帝国遗产并没有消失，而是被新权力不断改造。再走到纳沃纳广场，地下仍是古罗马竞技场的形状，地上却是巴洛克教堂、喷泉和今天的城市生活。一天结束时，你看到的不是三个分散景点，而是三次接力：教皇收藏古代、城堡改写帝国、广场把旧空间继续变成现代生活。", chapters: [{ label: "01", title: "梵蒂冈博物馆：教皇收藏罗马", text: "收藏不是杂物堆积，而是对古代、宗教与欧洲文明的重新编排。" }, { label: "02", title: "西斯廷教堂：艺术成为权力", text: "米开朗基罗的图像把创世纪变成关于解释权的公开宣言。" }, { label: "03", title: "圣天使堡：皇帝陵墓变成教皇要塞", text: "同一栋建筑的用途变化，最直接地展示了权力如何继承旧罗马。" }, { label: "04", title: "纳沃纳广场：古代形状进入现代生活", text: "竞技场的城市轮廓被巴洛克与当代街道继续使用。" }], prompt: "请按我9月28日的实际路线，写成适合现场口播的8分钟故事：上午梵蒂冈博物馆与西斯廷教堂，之后经过圣天使堡外观去纳沃纳广场。重点讲教皇如何收藏罗马、皇帝陵墓如何变成教皇要塞、古代竞技场如何变成巴洛克广场；最后用一句话连接前一天的斗兽场。\n\n现场补充：" },
    source: "正式方案 PDF + 9 月 28 日最新安排｜上午梵蒂冈博物馆，之后经圣天使堡到纳沃纳广场；教宗大殿名单待确认",
  },
  {
  ...
  },
  {
    ...
    route: ["军队广场 / Place d’Armes", "凡尔赛宫 / Château de Versailles", "网球厅 / Salle du Jeu de Paume", "凡尔赛花园", "凯旋门"], transport: ["巴黎 ↔ 凡尔赛：按正式方案交通", "宫殿 → 网球厅：从城市一侧出宫，步行约10分钟；导航 1 rue du Jeu de Paume", "凡尔赛 → 巴黎市区：车辆 / RER 以安排为准"], meals: ["午餐：网球厅参观后在凡尔赛周边安排", "晚餐：凯旋门结束后在巴黎市区自选"],
    activities: [
    ...
    story: { title: "10月6日：王室离开凡尔赛的同一天", question: "法国的最高权力，怎样从国王身上转向了“国民”？", lead: "你在2026年10月6日来到凡尔赛；1789年的同一天，路易十六一家被迫离开这里，凡尔赛从此不再是法国君主的常住宫殿。", body: "今天先在军队广场看群众、军队与宫门相遇的空间，再进王宫寻找皇家歌剧院、王后卧室床龛左侧的小门和大理石庭院。离开宫殿后步行到网球厅，把时间拨回1789年6月20日：代表们宣誓在制定宪法前绝不解散。革命在凡尔赛最关键的变化，不是先砍掉一个国王，而是先提出一个新的政治问题——法国究竟属于国王，还是属于组成国家的人民？下午回到巴黎，凯旋门会让你看到革命释放出的群众动员如何被拿破仑重新集中为国家荣耀。巴黎圣母院留到第二天再看，让今天的主线完整停在“革命如何被国家重新书写”。", chapters: [{ label: "01", title: "五月：三级会议", text: "Hôtel des Menus-Plaisirs里，财政危机把三个等级召集到一起，也把“谁代表法国”变成公开冲突。" }, { label: "02", title: "六月：网球厅宣誓", text: "代表们不再只是向国王陈情，而以国民议会的名义要求制定宪法。" }, { label: "03", title: "十月：王室离开", text: "妇女进军凡尔赛后，王室被带往巴黎；政治中心也离开了王宫。" }, { label: "04", title: "革命之后的国家", text: "凯旋门把革命与战争动员写进帝国和民族国家的纪念体系。" }], prompt: "请把2026年10月6日的凡尔赛行程写成一段可以现场讲给老婆听的8分钟故事。必须使用中法双语地点名，并按现场顺序讲：Place d’Armes、Opéra Royal、Chambre de la Reine床龛左侧小门、Cour de Marbre、Salle du Jeu de Paume；Hôtel des Menus-Plaisirs只作为时间允许的补线。讲清1789年5月三级会议、6月20日网球厅宣誓、10月5—6日妇女进军和王室离开的因果关系；最后接到凯旋门。\n\n现场补充：" },
    source: "正式方案 PDF｜凡尔赛、凯旋门；凡尔赛宫、凡尔赛市与旅游局官方资料补充革命现场；巴黎圣母院按最终确认移至10月7日",
  },
  {
    id: "day-12", number: "12", date: "10月7日", city: "巴黎", tag: "已确定", title: "从中世纪巴黎走进现代艺术",
    route: ["巴黎圣母院", "奥赛美术馆", "塞纳河畔看风景 / 吃饭"], transport: ["酒店 → 巴黎圣母院：地铁 / 车辆，以当天出发时间为准", "巴黎圣母院 → 奥赛美术馆：沿塞纳河向西，可步行或乘车"], meals: ["午餐：巴黎圣母院至奥赛之间顺路解决", "晚餐：奥赛美术馆出来后，在塞纳河畔看风景、吃饭"],
    photoIdeas: ["奥赛美术馆出来后不再跨城加点，直接把塞纳河、桥梁与傍晚光线留作当天收尾。", "如果天气不好，先在奥赛周边找室内座位，等雨小后再到河畔短暂停留。"],
    priorityReminder: { label: "最终确定 / 10 月 7 日", title: "巴黎圣母院 + 奥赛美术馆", body: "上午先去巴黎圣母院，之后前往奥赛美术馆；参观结束不再赶下一处景点，直接在塞纳河畔看风景、吃饭。", items: ["巴黎圣母院｜Notre-Dame de Paris", "奥赛美术馆｜Musée d’Orsay", "收尾｜奥赛出来后留在塞纳河畔"] },
    activities: [
      { id: "d12-1", time: "上午", title: "巴黎圣母院", place: "Notre-Dame de Paris", note: "10 月 7 日已确定安排；入内时间以预约和现场队伍为准", kind: "visit" },
      { id: "d12-2", time: "中午", title: "午餐 / 前往奥赛", place: "塞纳河沿线", note: "按奥赛预约时间留出转场余量", kind: "meal" },
      { id: "d12-3", time: "下午", title: "奥赛美术馆", place: "Musée d’Orsay", note: "从19世纪艺术看巴黎如何进入现代", kind: "visit" },
      { id: "d12-4", time: "奥赛出来后", title: "塞纳河畔看风景 / 吃饭", place: "Seine · Musée d’Orsay 周边", note: "当天收尾，不再跨城加景点", kind: "meal" },
    ],
    story: { title: "从圣母院到奥赛：巴黎怎样把旧城变成现代文化", question: "同一条塞纳河，怎样连接中世纪信仰、现代城市与公共艺术？", lead: "上午在巴黎圣母院看中世纪城市的精神中心，下午到奥赛看19世纪艺术如何重新发明巴黎；两处之间不是两个孤立景点，而是城市历史沿塞纳河展开的一条时间线。", body: "巴黎圣母院让人看到中世纪城市怎样围绕教会、河流和岛屿组织生活。到了奥赛美术馆，空间本身已经进入另一个时代：曾经的火车站被改造成博物馆，工业城市的交通建筑开始收藏印象派和现代生活。画里的街道、咖啡馆、舞会和河岸，正是你走出馆门后仍能看到的巴黎。最后不必再赶路，就在塞纳河畔坐下来吃饭，把今天收成一句话：巴黎没有丢掉旧城，而是不断把旧空间改写成新的公共文化。", chapters: [{ label: "01", title: "圣母院：中世纪城市的中心", text: "教堂、城市与塞纳河共同组织了巴黎人的信仰和日常生活。" }, { label: "02", title: "奥赛：火车站变成美术馆", text: "工业时代的交通建筑，被重新用来讲述现代艺术与现代生活。" }, { label: "03", title: "塞纳河：让两种巴黎相遇", text: "走出奥赛后看到的河岸，把中世纪遗产和现代城市接在同一幅风景里。" }], prompt: "请把巴黎圣母院、奥赛美术馆和奥赛出来后的塞纳河畔晚餐串成一段 5 分钟故事。重点讲中世纪城市、19世纪现代艺术与今天的巴黎如何沿塞纳河连接起来，语气像我讲给老婆听。\n\n现场补充：" },
    source: "正式方案 PDF + 10 月 7 日最终确认｜巴黎圣母院、奥赛美术馆、奥赛出来后塞纳河畔看风景吃饭",
  },
  {
