...
const dailyMaps: Record<string, DayMap> = {
  ...
  "day-04": {
    ...
    note: "佛罗伦萨酒店已确认在 Viale Fratelli Rosselli, 2；这里先看 9 月 29 日第一天的酒店 / 火车站与老城景点关系。9 月 30 日的两座博物馆在下一天地图单独展开。",
  },
  "day-05": {
    city: "佛罗伦萨",
...
const basePlans: DayPlan[] = [
  ...
  },
  {
    ...
    story: { title: "佛罗伦萨为什么能接过罗马的火炬？", question: "罗马帝国消失以后，新的欧洲为什么从城邦竞争中长出来？", lead: "今天不是从帝国跳进美术馆，而是看城市如何重新获得政治主动权。明天再用学院美术馆和巴杰罗，把这条雕塑线补完整。", body: "佛罗伦萨的银行、广场、教堂和美术馆共同说明了一件事：财富本身不会自动变成合法性。美第奇家族必须把银行赚来的钱转化为建筑、画作和公共荣耀，让整座城市不断重复一个印象——这个家族有能力让佛罗伦萨变得更伟大。文艺复兴因此不是艺术突然自由了，而是艺术被卷入城邦竞争，成为城市争夺信用、声望和权力的方式。今天先看乌菲兹、百花大教堂和领主广场如何把财富、城市和公共荣耀连在一起；明天的学院美术馆与巴杰罗国家博物馆，再把这条线推进到米开朗基罗、多纳太罗和佛罗伦萨的雕塑传统。这样两天连起来，看的就不只是名作，而是城邦怎样用艺术塑造自己的公民形象。", chapters: [{ label: "01", title: "城邦竞争", text: "城市之间的竞争，让公共建筑成为政治声明。" }, { label: "02", title: "美第奇赞助", text: "银行财富必须经过艺术和公共荣耀，才能变成政治信用。" }, { label: "03", title: "明天补雕塑线", text: "学院美术馆看《大卫》，巴杰罗国家博物馆看佛罗伦萨雕塑传统，记住 9 月 30 日这一安排。" }, { label: "04", title: "从罗马到佛罗伦萨", text: "罗马留下的古典遗产，在城邦竞争中被重新激活。" }], prompt: "请把佛罗伦萨两天的故事串起来：第一天的乌菲兹、百花大教堂、领主广场，第二天（9 月 30 日）的学院美术馆和巴杰罗国家博物馆。重点讲‘城邦竞争如何把艺术变成政治’，并把米开朗基罗《大卫》与多纳太罗的雕塑传统连接起来。写成我可以现场口播的 6 分钟故事。\n\n原稿：" },
